...
require (
	...
	github.com/openziti/channel/v2 v2.0.24 // indirect
	github.com/openziti/foundation/v2 v2.0.9 // indirect
	github.com/openziti/identity v1.0.28 // indirect
	github.com/openziti/metrics v1.2.2 // indirect
	github.com/openziti/transport/v2 v2.0.48 // indirect
